...
`03_Golden_Engineering_Playbook.md` v1.6 Baseline、`guides/04_Framework_Overview.md` v1.6 Candidate、`guides/05_Decision_Tree.md` v1.7 Candidate 與 `training/06_Training_Presentation.pptx` v1.11 Baseline Candidate 已同步 simplicity/effectiveness correction 與 role-based navigation。Supporting adoption assets：
