...
| Capability routing | 客觀 engineering need 先決定 required capability；Team fit 再選 default/equivalent；交接與維護需求決定記錄位置 |
...
`03_Golden_Engineering_Playbook.md` v1.7 Baseline、`guides/04_Framework_Overview.md` v1.8 Candidate、`guides/05_Decision_Tree.md` v1.8 Candidate 與 `training/06_Training_Presentation.pptx` v1.11 Baseline Candidate 已同步 capability routing 與 role-based navigation。Supporting adoption assets：
