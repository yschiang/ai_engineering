...
| 06 | `presentation/06_Training_Presentation.pptx` | PowerPoint，11 頁 | v1.5 Baseline Candidate；以 8 週 → 6 週示意 AI Engineering target outcome，待 Sponsor/Engineering confirmation |
...
- `presentation/06_Training_Presentation.pptx` v1.5 Baseline Candidate 已將 target outcome comparison 定稿為 8 週 → 6 週（4 → 3 個 two-week Sprints）：前 2 週投資 Research／Design／Plan，中間 2 週 Implement，最後 2 週 Validate，明確納入 TDD、staging 與 production readiness。圖表以 PNG 嵌入，並標示需由 pilot actual baseline 校準。
...
1. Sponsor/Engineering confirmation `presentation/06_Training_Presentation.pptx` v1.5 Baseline Candidate 的 storyline、Golden Matrix routing correctness、8 週 → 6 週 target assumptions、training pacing 與 call to action。
...
5. Training Presentation v1.5 Baseline Candidate 的 11 頁 pacing、Golden Matrix routing correctness、8 週 → 6 週 calendar allocation assumptions 與 team mission 是否適合 Department Meeting。
...
> **Read `00_Project_Charter.md` v1.3, `01_AI_Handoff.md` v1.14, `02_Framework.md` v1.4, `03_Golden_Engineering_Playbook.md` v1.2 Baseline, `diagrams/04_Framework_Overview.md` v1.2 Candidate, `diagrams/05_Decision_Tree.md` v1.3 Candidate, and `presentation/06_Training_Presentation.pptx` v1.5 Baseline Candidate. Confirm the Golden Matrix routing correctness, deck storyline, representative routes, 8 週 → 6 週 target assumptions, roles and team mission. After approval, create `07_Quick_Reference_Guide` as a true one-page start/review/release aid derived from 04–06; do not compress the Framework table of contents into a page.**
...
- [ ] 06 v1.5 Baseline Candidate 已是實際 11 頁 PowerPoint；target outcome slide 使用 8 週 → 6 週 calendar-time illustration，bar chart 為嵌入式 PNG，並完成 CJK render、逐頁 visual inspection、overflow 與 template fidelity QA。
- [ ] 下一步是 confirm 06 v1.5 的 routing、cycle-time assumptions 與 pacing；核准後建立 `07_Quick_Reference_Guide` one pager。
