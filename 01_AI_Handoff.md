...
| 04 | `diagrams/04_Framework_Overview.md` | Diagram / Markdown | v1.1 Candidate；已同步 hierarchy/planning correction，待 Sponsor review |
| 05 | `diagrams/05_Decision_Tree.md` | Diagram / Markdown | v1.0 Candidate；60-second work/risk/stage/skill/artifact/gate router，待 Sponsor/Engineering review |
| 06 | `06_Training_Presentation.pptx` | PowerPoint，8–10 頁 | Pending supplement；部門 training |
...
- `diagrams/04_Framework_Overview.md` v1.1 Candidate 已同步 corrected hierarchy/planning split，待 Sponsor review。
- `diagrams/05_Decision_Tree.md` v1.0 Candidate 已建立，涵蓋 Work Level、P0 type、Archetype、Control Profile、System Design、Current Stage、next skill/artifact/gate routing。
...
1. Sponsor/Engineering review `diagrams/04_Framework_Overview.md` v1.1 與 `diagrams/05_Decision_Tree.md` v1.0 的 clarity、routing correctness 與 daily usability。
2. 核准後產生 `06_Training_Presentation.pptx`，由 04/05 建立 8–10 頁 training storyline。
3. 產生 `07_Quick_Reference_Guide` one pager。
...
5. Training Presentation 以 Department training 為主，同時保留 Division Head/CIO 可理解的 management narrative。
...
> **Read `00_Project_Charter.md` v1.3, `01_AI_Handoff.md` v1.6, `02_Framework.md` v1.4, `03_Golden_Engineering_Playbook.md` v1.2 Baseline, `diagrams/04_Framework_Overview.md` v1.1 Candidate, and `diagrams/05_Decision_Tree.md` v1.0 Candidate. Review 04/05 for one-page clarity, routing correctness, practical engineering tone, and 60-second usability. After approval, create the actual `06_Training_Presentation.pptx` in 8–10 pages using the same hierarchy, Golden Flow, planning split, skills, artifacts, gates, and representative scenarios. Do not add a lifecycle stage or turn the deck into a tool manual.**
...
- [ ] 03 v1.2 已是 Baseline；04 v1.1 與 05 v1.0 Candidate 已建立。
- [ ] 下一步是 review 04/05；核准後建立實際 `06_Training_Presentation.pptx`。
