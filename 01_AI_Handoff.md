...
| 06 | `presentation/06_Training_Presentation.pptx` | PowerPoint，10 頁 | v1.0 Candidate；Department training storyline，待 Sponsor/Engineering review |
...
- `presentation/06_Training_Presentation.pptx` v1.0 Candidate 已完成 10 頁 Department training deck，涵蓋 Why、Operating Model、Work Level、Golden Matrix、planning split、capability responsibility、control/gates、common routes、roles 與 team mission。
...
1. Sponsor/Engineering review `presentation/06_Training_Presentation.pptx` v1.0 Candidate 的 storyline、training pacing、matrix legibility 與 call to action。
...
5. Training Presentation v1.0 Candidate 的 10 頁 pacing、Golden Matrix legibility 與 team mission 是否適合 Department Meeting。
...
> **Read `00_Project_Charter.md` v1.3, `01_AI_Handoff.md` v1.9, `02_Framework.md` v1.4, `03_Golden_Engineering_Playbook.md` v1.2 Baseline, `diagrams/04_Framework_Overview.md` v1.2 Candidate, `diagrams/05_Decision_Tree.md` v1.2 Candidate, and `presentation/06_Training_Presentation.pptx` v1.0 Candidate. Review the deck's storyline, matrix readability, representative routes, roles and team mission. After approval, create `07_Quick_Reference_Guide` as a true one-page start/review/release aid derived from 04–06; do not compress the Framework table of contents into a page.**
...
- [ ] 06 v1.0 Candidate 已是實際 10 頁 PowerPoint，並完成 render/overflow QA。
- [ ] 下一步是 review 06；核准後建立 `07_Quick_Reference_Guide` one pager。
