...
| 06 | `presentation/06_Training_Presentation.pptx` | PowerPoint，11 頁 | v1.3 Baseline Candidate；新增 AI Engineering target outcome comparison，待 Sponsor/Engineering confirmation |
...
- `presentation/06_Training_Presentation.pptx` v1.3 Baseline Candidate 已在 corrected Golden Matrix 後加入 target outcome comparison：以相同 total effort 的 continuous stacked bars 呈現 effort 從 coding 轉向 system-wide Research、explicit Design/Plan 與 broader Validate；implementation 目標降至原本約 1/5–1/10，並明確標示為待 pilot baseline 校準的 target illustration。
...
1. Sponsor/Engineering confirmation `presentation/06_Training_Presentation.pptx` v1.3 Baseline Candidate 的 storyline、Golden Matrix routing correctness、target outcome assumptions、training pacing 與 call to action。
...
5. Training Presentation v1.3 Baseline Candidate 的 11 頁 pacing、Golden Matrix routing correctness、target effort mix assumptions 與 team mission 是否適合 Department Meeting。
...
> **Read `00_Project_Charter.md` v1.3, `01_AI_Handoff.md` v1.12, `02_Framework.md` v1.4, `03_Golden_Engineering_Playbook.md` v1.2 Baseline, `diagrams/04_Framework_Overview.md` v1.2 Candidate, `diagrams/05_Decision_Tree.md` v1.3 Candidate, and `presentation/06_Training_Presentation.pptx` v1.3 Baseline Candidate. Confirm the Golden Matrix routing correctness, deck storyline, representative routes, target outcome assumptions, roles and team mission. After approval, create `07_Quick_Reference_Guide` as a true one-page start/review/release aid derived from 04–06; do not compress the Framework table of contents into a page.**
...
- [ ] 06 v1.3 Baseline Candidate 已是實際 11 頁 PowerPoint；target outcome slide 使用相同 total effort 的 illustrative comparison，並完成 CJK render、逐頁 visual inspection、overflow 與 template fidelity QA。
- [ ] 下一步是 confirm 06 v1.3 的 routing、effort-mix assumptions 與 pacing；核准後建立 `07_Quick_Reference_Guide` one pager。
