...
| 06 | `presentation/06_Training_Presentation.pptx` | PowerPoint，10 頁 | v1.2 Baseline Candidate；Golden Matrix semantic correction complete，待 Sponsor/Engineering confirmation |
...
- `presentation/06_Training_Presentation.pptx` v1.2 Baseline Candidate 已完成 Golden Matrix semantic correction：修正 P3 Product/Program、Greenfield/Modernization research、P0 Bug research、System Design trigger、P1→P0/P0→tasks planning、recursive implementation 與 validation outputs；保持 16pt room readability。
...
1. Sponsor/Engineering confirmation `presentation/06_Training_Presentation.pptx` v1.2 Baseline Candidate 的 storyline、Golden Matrix routing correctness、training pacing 與 call to action。
...
5. Training Presentation v1.2 Baseline Candidate 的 10 頁 pacing、Golden Matrix routing correctness 與 team mission 是否適合 Department Meeting。
...
> **Read `00_Project_Charter.md` v1.3, `01_AI_Handoff.md` v1.11, `02_Framework.md` v1.4, `03_Golden_Engineering_Playbook.md` v1.2 Baseline, `diagrams/04_Framework_Overview.md` v1.2 Candidate, `diagrams/05_Decision_Tree.md` v1.3 Candidate, and `presentation/06_Training_Presentation.pptx` v1.2 Baseline Candidate. Confirm the Golden Matrix routing correctness, deck storyline, representative routes, roles and team mission. After approval, create `07_Quick_Reference_Guide` as a true one-page start/review/release aid derived from 04–06; do not compress the Framework table of contents into a page.**
...
- [ ] 06 v1.2 Baseline Candidate 已是實際 10 頁 PowerPoint，並完成 CJK render、逐頁 visual inspection 與 overflow QA。
- [ ] 下一步是 confirm 06 v1.2；核准後建立 `07_Quick_Reference_Guide` one pager。
