...
| 05 | `diagrams/05_Decision_Tree.md` | Diagram / Markdown | v1.2 Candidate；新增 P3–P0 × Golden Stage skill/output matrix，待 Sponsor/Engineering review |
| 06 | `presentation/06_Training_Presentation.pptx` | PowerPoint，10 頁 | v1.1 Baseline Candidate；targeted legibility/command/handoff patch complete，待 Sponsor/Engineering confirmation |
...
- `diagrams/05_Decision_Tree.md` v1.2 Candidate 已補齊 top-level 60-second router、P3–P0 × Stage skill/output matrix、P1/P0 boundary、Release/Operate overlay、explicit OpenSpec next actions 與 appendices。
- `presentation/06_Training_Presentation.pptx` v1.1 Baseline Candidate 已完成 targeted patch：Golden Matrix 與 capability text 提升至 room-readable 16pt、OpenSpec commands 完整限定、Evidence Gate 後的 Release/Operate handoff 明確化，並指定 Tech Lead 在 Sprint Review 檢查 adoption evidence/friction。
...
1. Sponsor/Engineering confirmation `presentation/06_Training_Presentation.pptx` v1.1 Baseline Candidate 的 storyline、training pacing、matrix legibility 與 call to action。
2. Sponsor/Engineering 同步確認 `diagrams/04_Framework_Overview.md` v1.2 與 `diagrams/05_Decision_Tree.md` v1.2 後轉 Baseline。
...
5. Training Presentation v1.1 Baseline Candidate 的 10 頁 pacing、Golden Matrix legibility 與 team mission 是否適合 Department Meeting。
...
> **Read `00_Project_Charter.md` v1.3, `01_AI_Handoff.md` v1.10, `02_Framework.md` v1.4, `03_Golden_Engineering_Playbook.md` v1.2 Baseline, `diagrams/04_Framework_Overview.md` v1.2 Candidate, `diagrams/05_Decision_Tree.md` v1.2 Candidate, and `presentation/06_Training_Presentation.pptx` v1.1 Baseline Candidate. Confirm the deck's storyline, matrix readability, representative routes, roles and team mission. After approval, create `07_Quick_Reference_Guide` as a true one-page start/review/release aid derived from 04–06; do not compress the Framework table of contents into a page.**
...
- [ ] 03 v1.2 已是 Baseline；04 v1.2 與 05 v1.2 Candidate 已完成 targeted revision + Golden Matrix。
- [ ] 06 v1.1 Baseline Candidate 已是實際 10 頁 PowerPoint，並完成 CJK render、逐頁 visual inspection 與 overflow QA。
- [ ] 下一步是 confirm 06 v1.1；核准後建立 `07_Quick_Reference_Guide` one pager。
