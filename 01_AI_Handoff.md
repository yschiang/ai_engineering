...
| 05 | `diagrams/05_Decision_Tree.md` | Diagram / Markdown | v1.1 Candidate；已完成 60-second router、Release handoff 與 routing targeted patch，待 Sponsor/Engineering review |
...
- `diagrams/05_Decision_Tree.md` v1.1 Candidate 已補齊 top-level 60-second router、P1/P0 boundary、Release/Operate overlay、explicit OpenSpec next actions 與 appendices。
...
1. Sponsor/Engineering confirm `diagrams/04_Framework_Overview.md` v1.2 與 `diagrams/05_Decision_Tree.md` v1.1 targeted revision 的 clarity、routing correctness 與 daily usability。
...
> **Read `00_Project_Charter.md` v1.3, `01_AI_Handoff.md` v1.7, `02_Framework.md` v1.4, `03_Golden_Engineering_Playbook.md` v1.2 Baseline, `diagrams/04_Framework_Overview.md` v1.2 Candidate, and `diagrams/05_Decision_Tree.md` v1.1 Candidate. Confirm the targeted 04/05 revision for one-page clarity, routing correctness, practical engineering tone, and 60-second usability. After approval, create the actual `06_Training_Presentation.pptx` in 8–10 pages using the same hierarchy, Golden Flow, planning split, skills, artifacts, gates, Release/Operate handoff, and representative scenarios. Do not add a lifecycle stage or turn the deck into a tool manual.**
...
- [ ] 03 v1.2 已是 Baseline；04 v1.2 與 05 v1.1 Candidate 已完成 targeted revision。
