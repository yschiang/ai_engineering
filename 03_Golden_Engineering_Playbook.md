...
> Governing Framework: `02_Framework.md` v1.5  
...
這張對應表是 capability translation，不是 SDLC prescription。Team 的 Intake、Refinement、Sprint、PR、Release 或 Incident flow 可以合併、改名、重排；只要保留 Golden Stage 的工程問題、minimum contract、decision owner 與 risk-based evidence。
...
- 首先問 existing work location 與最大未知/風險，再選 capability、artifact placement 與 gate。
